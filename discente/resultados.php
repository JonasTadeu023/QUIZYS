...
.nav-content  {
  ...
  body{
    ...
    <div class="container">
       <nav class="nav-extended">
          <div class="nav-wrapper">
              <a href="#" class="brand-logo">Resultados dos testes concluidos:</a>
    ...
    <center><h5>Resultados de <?php echo $aluno;?></h5></center>
<div class="container">
<div class="row">
      <div class="card">
            <table class="striped">
    ...
    <tbody>
          <?php
            include 'includes/resultados_testes.php';
      ?>
    </tbody>
</table>
 <div class="row">
